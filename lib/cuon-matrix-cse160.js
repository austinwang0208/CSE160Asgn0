 ...
 */
 ...
 class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        const crossX = other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1];
        const crossY = other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2];
        const crossZ = other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0];

        // console.log(crossX, crossY, crossZ);
        let v3 = new Vector3([crossX, crossY, crossZ]); // Modify this line to calculate cross product between other1 and other2.
        // console.log("cross", v3.elements[0], v3.elements[1], v3.elements[2])
        // Don't delete the return statement.
        return v3;
    }
